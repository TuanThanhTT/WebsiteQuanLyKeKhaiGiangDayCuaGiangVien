...
function updatePhanTrangTableKeKhai(totalPages, currentPage) {
    ...
    prev.innerHTML = '<a class="page-link" href="#" onclick="loadDanhSachKhoa(' + (currentPage - 1) + ')">Trước</a>';
    ...
    for (let i = 1; i <= totalPages; i++) {
        ...
        page.innerHTML = '<a class="page-link" href="#" onclick="loadDanhSachKhoa(' + i + ')">' + i + '</a>';
    ...
    next.innerHTML = '<a class="page-link" href="#" onclick="loadDanhSachKhoa(' + (currentPage + 1) + ')">Sau</a>';
