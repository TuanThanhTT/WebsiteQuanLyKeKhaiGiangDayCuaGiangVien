...
function updatePhanTrangTableHocPhan(totalPages, currentPage) {
    ...
    prev.innerHTML = '<a class="page-link" href="#" onclick="loadDanhSachHocPhan(' + (currentPage - 1) + ')">Trước</a>';
    ...
    for (let i = 1; i <= totalPages; i++) {
        ...
        page.innerHTML = '<a class="page-link" href="#" onclick="loadDanhSachHocPhan(' + i + ')">' + i + '</a>';
    ...
    next.innerHTML = '<a class="page-link" href="#" onclick="loadDanhSachHocPhan(' + (currentPage + 1) + ')">Sau</a>';
