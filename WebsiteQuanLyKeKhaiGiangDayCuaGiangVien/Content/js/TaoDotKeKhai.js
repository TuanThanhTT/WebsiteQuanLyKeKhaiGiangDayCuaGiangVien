...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const modal = document.getElementById("modalTaoDotKeKhai");
    const openModal = document.getElementById("openModal"); // Bạn cần có một button hoặc event để mở modal
    const closeModal = document.getElementById("closeModal");
    const closeModalHeader = document.getElementById("closeModalHeader");

    if (modal && openModal && closeModal && closeModalHeader) {
        // Open modal
